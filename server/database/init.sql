...
-- Engine: MariaDB
-- 1 database shared by all 4 servers
-- ============================================
...
-- ============================================
-- TABLE: users
-- login-server: register/login, token, language
-- main-server: game state
-- ============================================
...
-- ============================================
-- TABLE: servers
-- Konfigurasi game server (GetServerList)
-- ============================================
...
-- ============================================
-- TABLE: login_history
-- Track server yang pernah dimain user (GetServerList history, SaveHistory)
-- ============================================
...
-- Detail login tracking (SaveUserEnterInfo)
-- ============================================
